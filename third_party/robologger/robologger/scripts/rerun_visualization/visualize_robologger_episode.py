...
Examples:
  ...
  python visualize_robologger_episode.py /path/to/robologger_data

  # Visualize specific episode
  python visualize_robologger_episode.py /path/to/robologger_data/episode_data.zarr/episode_0

  # Process all frames (slower but more detailed)
  python visualize_robologger_episode.py /path/to/robologger_data --max-frames 10000

  # Show every video frame (slower)
  python visualize_robologger_episode.py /path/to/robologger_data --video-rate 1
        """
    )
