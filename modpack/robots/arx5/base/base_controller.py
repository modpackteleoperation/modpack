...
from .constants import h_x, h_y, ENCODER_MAGNET_OFFSETS, POLICY_CONTROL_PERIOD
from .base_utils import create_pid_file
...
class Motor:
    def __init__(self, num):
        ...
        if self.num == 1:
            supply_voltage_signal = self.fx.get_supply_voltage()
            supply_voltage_signal.wait_for_update(5.0)  # First CAN device, wait for CAN bus to be ready
